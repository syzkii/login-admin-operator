		...
		<td width='100%'>
			...
			<tr>
				...
				<td width='50%' align='left'>
					<a href="logout.php" class="btn btn-lg btn-danger btn-kere3 text-uppercase font-weight-bold mb-2">Logout</a>
					<a href='add_siswa.php' class='btn btn-primary btn-kere2'> Tambah Data Siswa  </a>
					<?
						if($_SESSION["hak_akses"]=="admin")
						{
					?>
					<a href='user.php' class="btn btn-primary btn-kere4">User Admin</a> | 
					<?
						}
					?>
				</td>
			...
			while ($data = mysql_fetch_assoc($query))
				...
				<TR>
					...
					<TD align='center'>
						<a href='edit_siswa.php?no_induk=<?php echo $data["no_induk"]; ?>' class="btn btn-warning"><i class="fa fa-edit">Edit</a>
						<br><br>
						<a href='delete_siswa.php?no_induk=<?php echo $data["no_induk"]; ?>' class="btn btn-danger"><i class="fa fa-trash-o">Delete</a>
					</TD>
				</TR>				
				<?php
					}
